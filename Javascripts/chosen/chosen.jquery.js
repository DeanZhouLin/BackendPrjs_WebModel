...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      if (this.options.search_contains == false) {
    ...
    AbstractChosen.prototype.set_default_text = function() {
      ...
      return this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || "没有匹配的数据";
    };
