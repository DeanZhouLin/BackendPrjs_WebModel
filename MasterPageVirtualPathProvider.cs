...
namespace Jufine.Backend.WebModel
{
    ...
    public class MasterPageVirtualPathProvider : System.Web.Hosting.VirtualPathProvider
    {
        ...
        public const string MasterPageBlankFileLocation = "~/MasterPageDir/MasterPageBlank.Master";
        public const string VirtualPathProviderResourceLocation = "Jufine.Backend.WebModel";
        public const string VirtualMasterPageDir = "~/MasterPageDir/";
        ...
        private static bool IsPathVirtual(string virtualPath)
        {
            ...
            return checkPath.StartsWith(VirtualMasterPageDir, StringComparison.InvariantCultureIgnoreCase);
        }
    }
}
